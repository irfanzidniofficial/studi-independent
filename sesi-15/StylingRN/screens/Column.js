...
const styles = StyleSheet.create({
  ...
  style1Box1: { flex: 1, backgroundColor: "#e74c3c" },
  style1Box2: { flex: 1, backgroundColor: "#95a5a6" },
  style1Box3: { flex: 1, backgroundColor: "#9b59b6" },

  style2Box: {
    flex: 1,
    flexDirection: "column",
  },
  style2Box1: { flex: 1, backgroundColor: "#e74c3c" },
  style2Box2: { flex: 2, backgroundColor: "#95a5a6" },
  style2Box3: { flex: 3, backgroundColor: "#9b59b6" },

  style3Box: {
    flex: 1,
    flexDirection: "row",
  },
  style3Box1: { flex: 1, backgroundColor: "#e74c3c" },
  style3Box2: { flex: 1, backgroundColor: "#95a5a6" },
  style3Box3: { flex: 1, backgroundColor: "#9b59b6" },
});
